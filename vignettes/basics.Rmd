...
```{r install-packages, include=F, message=F, warning=F, eval=F}
(function() {
...
```{r scmultisim-help, echo = T, results = "hide"}
...
We can also simulate discrete cell population by setting `discrete.cif = T`.
...
If we set `do.velocity = F`, scMultiSim will simulate the RNA counts using the Beta-Poisson model,
